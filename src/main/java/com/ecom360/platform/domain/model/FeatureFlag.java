...
public class FeatureFlag {
    ...
    @Column(name = "is_enabled", nullable = false) private Boolean isEnabled = true;
    ...
    public Boolean getIsEnabled() { return isEnabled; }  public void setIsEnabled(Boolean v) { this.isEnabled = v; }
