...
@RestController
@RequestMapping(ApiConstants.API_BASE + "/admin/audit-logs")
@Tag(name = "Admin Audit Logs", description = "Platform admin: view audit trail across all businesses")
...
public class AdminAuditController {
  ...
  @GetMapping
  @Operation(summary = "List audit logs (platform admin)")
