...
import com.ecom360.tenant.application.util.RoleCodeNormalizer;
...
public class BusinessUserService {
        ...
        .ifPresent(
            plan -> {
              ...
              if (!Boolean.TRUE.equals(plan.getFeatureRoleManagement())) {
                String code = RoleCodeNormalizer.toBusinessRoleCode(req.role());
                if (!"CAISSIER".equals(code)) {
                  throw new BusinessRuleException(
  ...
  @Transactional
  public List<StoreResponse> assignStores(
