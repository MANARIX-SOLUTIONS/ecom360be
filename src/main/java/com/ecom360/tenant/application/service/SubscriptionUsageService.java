...
public class SubscriptionUsageService {
    ...
    public SubscriptionUsageService(SubscriptionService subscriptionService,
    ...
    public SubscriptionUsageResponse getUsage(UserPrincipal p) {
        ...
        long salesThisMonth = saleRepository.countByBusinessIdAndCreatedAtBetween(businessId, start, end);
        ...
        return new SubscriptionUsageResponse(
                ...
                storesCount, storesLimit,
                (int) productsCount, productsLimit,
                (int) clientsCount, clientsLimit,
                (int) suppliersCount, suppliersLimit,
                salesThisMonth, salesLimit
        );
    }
}
