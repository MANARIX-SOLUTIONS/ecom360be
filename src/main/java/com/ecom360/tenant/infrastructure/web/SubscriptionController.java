...
public class SubscriptionController {
    ...
    public SubscriptionController(SubscriptionService subscriptionService, SubscriptionUsageService subscriptionUsageService) {
    ...
    public ResponseEntity<SubscriptionUsageResponse> getUsage(@AuthenticationPrincipal UserPrincipal p) {
    ...
    public ResponseEntity<SubscriptionResponse> getCurrent(@AuthenticationPrincipal UserPrincipal p) {
        return subscriptionService.getCurrent(p)
    ...
    public ResponseEntity<SubscriptionResponse> changePlan(@Valid @RequestBody ChangePlanRequest req,
