...
public class StockMovement {
  ...
  public static StockMovement record(
    ...
    m.type = type;
    m.quantity = qty;
    m.quantityBefore = before;
    m.quantityAfter = after;
    m.reference = ref;
    m.note = note;
    return m;
  }
  ...
  public void setQuantityBefore(Integer v) {
    this.quantityBefore = v;
  }
  ...
  public void setQuantityAfter(Integer v) {
    this.quantityAfter = v;
  }
