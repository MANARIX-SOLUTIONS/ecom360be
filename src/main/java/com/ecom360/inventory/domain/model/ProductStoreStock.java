...
@Entity @Table(name = "product_store_stock", uniqueConstraints = @UniqueConstraint(columnNames = {"product_id", "store_id"}))
public class ProductStoreStock {
    ...
    @PrePersist @PreUpdate protected void onUpdate() { updatedAt = Instant.now(); }
    ...
    public Integer getMinStock() { return minStock; } public void setMinStock(Integer v) { this.minStock = v; }
