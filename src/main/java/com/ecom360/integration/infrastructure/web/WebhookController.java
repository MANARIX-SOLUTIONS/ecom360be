...
public class WebhookController {
    ...
    public ResponseEntity<WebhookCreateResponse> create(@Valid @RequestBody WebhookRequest request,
    ...
    public ResponseEntity<WebhookResponse> get(@PathVariable UUID id, @AuthenticationPrincipal UserPrincipal p) {
        return ResponseEntity.ok(webhookService.getById(id, p));
    }

    @PutMapping("/{id}")
    @Operation(summary = "Update webhook")
    public ResponseEntity<WebhookResponse> update(@PathVariable UUID id, @Valid @RequestBody WebhookRequest request,
                                                 @AuthenticationPrincipal UserPrincipal p) {
