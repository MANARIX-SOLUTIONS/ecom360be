...
public interface CommerceOrderIngestionLogRepository
        ...
        Page<CommerceOrderIngestionLog> findByBusinessIdOrderByCreatedAtDesc(
                        UUID businessId, Pageable pageable);

        Page<CommerceOrderIngestionLog> findByBusinessIdAndConnectionIdOrderByCreatedAtDesc(
                        UUID businessId, UUID connectionId, Pageable pageable);
}
