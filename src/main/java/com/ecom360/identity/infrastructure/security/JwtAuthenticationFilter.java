...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  public JwtAuthenticationFilter(
      JwtService jwtService, CachedRolePermissions cachedRolePermissions) {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      if (StringUtils.hasText(jwt)) {
        ...
        if (claims.roleId() != null && claims.businessId() != null) {
          for (String code : cachedRolePermissions.codesForRole(claims.roleId())) {
