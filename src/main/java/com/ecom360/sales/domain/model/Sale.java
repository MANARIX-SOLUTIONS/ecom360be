...
@Entity
@Table(name = "sale", uniqueConstraints = @UniqueConstraint(columnNames = "receipt_number"))
public class Sale {
  @Id
  ...
  public void setClientId(UUID v) {
    this.clientId = v;
  }
  ...
  public void setSubtotal(Integer v) {
    this.subtotal = v;
  }
  ...
  public void setDiscountAmount(Integer v) {
  ...
  public void setAmountReceived(Integer v) {
    this.amountReceived = v;
  }
  ...
  public void setChangeGiven(Integer v) {
    this.changeGiven = v;
  }
