...
public class CategoryController {
  ...
  public ResponseEntity<CategoryResponse> create(
      @Valid @RequestBody CategoryRequest r, @AuthenticationPrincipal UserPrincipal p) {
    return ResponseEntity.status(201).body(svc.create(r, p));
  }

  @GetMapping
  @Operation(summary = "List categories")
  public ResponseEntity<List<CategoryResponse>> list(@AuthenticationPrincipal UserPrincipal p) {
