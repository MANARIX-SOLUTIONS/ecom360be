...
public class Product extends BaseEntity {
    ...
    @Column(name = "cost_price", nullable = false) private Integer costPrice;
    @Column(name = "sale_price", nullable = false) private Integer salePrice;
    @Column(nullable = false) private String unit = "pièce";
    @Column(name = "image_url") private String imageUrl;
    @Column(name = "is_active", nullable = false) private Boolean isActive = true;
    public boolean belongsTo(UUID bizId) { return businessId.equals(bizId); }
    ...
    public Integer getCostPrice() { return costPrice; } public void setCostPrice(Integer v) { this.costPrice = v; }
    public Integer getSalePrice() { return salePrice; } public void setSalePrice(Integer v) { this.salePrice = v; }
