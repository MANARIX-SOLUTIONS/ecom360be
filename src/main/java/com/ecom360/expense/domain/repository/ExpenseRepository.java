...
import java.time.LocalDate; import java.util.Optional; import java.util.UUID;
@Repository public interface ExpenseRepository extends JpaRepository<Expense, UUID> {
    ...
    long sumAmountByBusinessIdAndDateBetween(@Param("b") UUID b, @Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
}
