...
public class AuditLogService {
  ...
  /**
   * Records an audit event. Uses IP and requestId from RequestContext when null. Runs
   * synchronously.
   */
  public void log(
      UUID bizId,
    ...
    repo.save(
        AuditLog.record(
            bizId, userId, action, entityType, entityId, changes, effectiveIp, requestId));
  }
  ...
  public Page<AuditLogResponse> listForAdmin(
      UserPrincipal p, UUID businessId, String entityType, UUID userId, Pageable pg) {
