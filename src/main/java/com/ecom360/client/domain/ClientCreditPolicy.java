...
/**
 * Règles du crédit client : solde positif = le client doit, négatif = trop-perçu.
...
public final class ClientCreditPolicy {
  ...
  public static final String PLAN_REQUIRED =
      "Crédits clients non inclus dans votre plan. Passez à un plan supérieur.";
  public static final String NAMED_CLIENT_REQUIRED =
      "Pour le crédit, sélectionnez un client nominatif.";
  public static final String NOTHING_OWED = "Ce client n'a pas de crédit en cours.";
  public static final String EXCEEDS_BALANCE =
      "Le paiement ne peut pas dépasser le solde dû.";
  public static final String WALK_IN_NO_PAYMENT =
      "Le client comptoir n'a pas de crédit nominatif.";
  public static final String IMPORT_CREDIT_FORBIDDEN =
      "Les ventes à crédit ne sont pas disponibles pour les importations commerce.";

  private static final Set<String> WALK_IN_ALIASES =
      Set.of("client comptoir", "walk-in", "walk in", "client anonyme");
